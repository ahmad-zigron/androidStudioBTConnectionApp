...
/**
 * Created by Nanha on 16/07/2017.
 */

public class TrafficConditionConnection extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.connection_traffic_condition);

        textConnectionStatus = (TextView) findViewById(R.id.connecting);
        textConnectionStatus.setTextSize(18);
    ...
    public void onResume()
    {
        ...
        if (pairedDevices.size() > 0) {
            ...
            mPairedDevicesArrayAdapter.add("There is Not Any Paired Device");
        }
    }
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener()
    {
        ...
        {
            textConnectionStatus.setText("Please Wait! Connecting...");
            // Get the device MAC address, which is the last 17 chars in the View
            String info = ((TextView) v).getText().toString();
            String address = info.substring(info.length() - 17);

            // Make an intent to start next activity while taking an extra which is the MAC address.
            Intent i = new Intent(TrafficConditionConnection.this, trafficcondition.class);
